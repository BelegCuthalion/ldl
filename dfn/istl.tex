The system $\GSTN$ is defined over the language $\L$ consisting of all the rules below. Moreover, the system $\GSTN_*$ is defined over $\L_*$ consisting of all the rules below, except $L \supset$ and $R \supset$.
